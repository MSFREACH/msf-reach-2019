...
export const UPDATE_REPORT_IN_LIST = 'updateReportInList';
...
export const FETCH_URL_START = 'setURLRequestLoading';
...
export const UPDATE_SITREP_SIGNEDURLS = 'setSitrepSignedUrls';
...
export const UPDATE_KEY_FIGURES = 'updateKeyFigures';

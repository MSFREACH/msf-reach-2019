export const KEY_FIGURES = [
  ...
  },
  {
    value: 'nutrition',
    text: 'Nutrition',
    options: [{ value: 'atfc', text: 'ATFC' }, { value: 'itfc', text: 'ITFC' }]
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      {
        value: 'hiv_1st_lines_inclusions',
        text: 'HIV 1st lines inclusions'
      },
      {
        value: 'hiv_2nd_lines_inclusions',
        text: 'HIV 2nd lines inclusions'
      },
      {
        value: 'hiv_2nd_lines_PMTCT inclusions',
        text: 'HIV 2nd lines PMTCT inclusions'
      },
      {
        value: 'hiv_2nd_lines_PMTCT mothers',
        text: 'HIV 2nd lines PMTCT mothers'
      },
      {
        value: 'hiv_2nd_lines_PMTCT babies',
        text: 'HIV 2nd lines PMTCT babies'
      },
  ...
  {
    value: 'surgery_and_violence',
    text: 'Surgery & violence',
    options: [
      { value: 'surgical_interventions', text: 'surgical interventions' },
      { value: 'sexual_violence', text: 'sexual violence' },
      {
        value: 'intentional_physical_violence',
        text: 'Intentional physical violence'
      },
      { value: 'victims_of_torture', text: 'victims of torture' }
    ]
  },
  {
    value: 'mental_health_consultations',
    text: 'Mental health consultations'
  },
  {
    ...
    options: [
      ...
      {
        value: 'hemorragic_fever_treatments',
        text: 'Hemorragic fever treatments'
      },
  ...
  },
  {
    ...
    options: [
      {
        value: 'measles_vaccination_outbreak',
        text: 'measles vaccination outbreak'
      },
      {
        value: 'meningittis_vaccination',
        text: 'meningittis vaccination'
      },
      {
        value: 'measle_vaccination_routine',
        text: 'measle vaccination routine'
      }
    ]
  },
  {
  ...
  {
    value: 'rescued_and_assisted',
    text: 'Migrants and refugees rescued and assisted',
    options: [

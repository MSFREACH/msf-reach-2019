<template>
  <v-layout row>
    <markdown-panel
      v-if="showMarkdown && dialog && e1 == 2"
      :elevation="210"
      class="createNewSidePanel"
    />
            ...
            <v-stepper-content step="2">
              <v-container grid-list-md class="create-wrapper">
                <div class="one-half">
                  ...
                  <v-text-field v-model="metadata.name" required />
                </div>
                ...
                <div class="top-align">
                  <div class="one-third">
                    ...
                    <v-flex
                      v-for="(item, index) in metadata.types"
                      :key="index"
                    ...
                    >
                      <div class="mb-2">
                        {{ item }}
                        <span
                          v-show="editable.typeIndex == index"
                          class="row-actions"
                        >
                  ...
                  <div class="one-third">
                    <label> Area(s) </label>
                    <div
                      v-for="(area, index) in metadata.areas"
                      v-if="metadata.areas"
                      v-model="metadata.areas"
                      class="tags"
                    >
                      ...
                      <span class="severity-wrapper">
                        <span
                          v-if="
                            metadata.severity_measures &&
                              metadata.severity_measures[index]
                          "
                          class="sub-tag"
                        >
                          <span
                ...
                <div class="top-align">
                  ...
                  <div class="one-third">
                    ...
                    <v-text-field
                      v-model="metadata.incharge_name"
                      label="Name"
                    />
                    <v-text-field
                      v-model="metadata.incharge_position"
                      label="Position"
                    />
                  </div>
                </div>
                ...
                <v-layout row wrap>
                  <v-flex xs6 style="display: inline-block;">
                    ...
                    <v-textarea
                      ...
                      auto-grow
                      placeholder="* supports markdown text formatting"
                    />
                  ...
                  <v-flex xs6 style="display: inline-block;">
                    ...
                    <div
                      ...
                      v-html="mdRender(metadata.description)"
                    />
                  </v-flex>
                </v-layout>
                <v-btn
                ...
                <hr class="row-divider" />
                <v-text-field
                  v-model="metadata.sharepoint_link"
    ...
    submitType() {
      ...
      if (this.subTypeSelect) {
        tmp.subtype == 'other'
          ...
          : this.metadata.types.push(tmp.subtype);

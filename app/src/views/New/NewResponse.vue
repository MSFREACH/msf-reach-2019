<template>
  <v-layout row wrap>
    <v-dialog v-model="dialog" persistent max-width="880px" hide-overlay>
      <v-btn slot="activator" :size="40" class="create-btn" fab small flat dark>
        <v-icon> add </v-icon>
      </v-btn>
      <template>
                ...
                <v-layout row wrap>
                  <div class="row-spacing">
                    ...
                    <div class="round-borders pc">
                      <v-select
                        v-model="newResponse.operational_center"
                  ...
                  <div class="one-half">
                    ...
                    <v-flex d-flex>
                      <v-select
                        v-model="newResponse.metadata.type"
                        :items="allResponseTypes"
                        label="type"
                      />
                    </v-flex>
                    <v-textarea
                      v-model="newResponse.metadata.description"
                      solo
                      label="description"
                      auto-grow
                  ...
                  <v-text-field
                    v-model="newResponse.metadata.sharepoint_link"

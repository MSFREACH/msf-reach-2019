<template>
  <v-toolbar :clipped-left="$vuetify.breakpoint.mdAndUp" app class="main-nav" flat fixed >
    ...
    <v-layout v-show="isAuthenticated" align-baseline>
      <v-toolbar-items>
        <router-link :to="{ name: 'events' }" class="top-nav-links"><v-btn flat>Event List</v-btn></router-link>
        <router-link :to="{ name: 'reports' }" class="top-nav-links"><v-btn flat>Report Cards</v-btn></router-link>
        <router-link :to="{ name: 'contacts' }" class="top-nav-links"><v-btn flat>Contacts</v-btn></router-link>
      </v-toolbar-items>
      <v-spacer/>
      <v-spacer/>

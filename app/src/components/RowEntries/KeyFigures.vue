      ...
      <template slot="item" slot-scope="props">
            ...
            <v-list two-line dense dark class="keyFigures-listWrapper">
              <v-list-tile class="keyFigures-list">
                ...
                <v-list-tile-action :class="hover ? 'showCrud' : 'hide'">
                  <a @click="editKeyFig(props.item, props.index)">
                    edit
                  </a>
                  <br />
                  <a @click="deleteKeyFig(props.item)">
                    delete
                  </a>
                </v-list-tile-action>
              </v-list-tile>
        ...
        >
          ...
          <v-flex xs8 class="selection-wrapper">
            <v-select v-model="editItem.category" dark :items="allKeyFigures" />
            <v-text-field
...
export default {
  ...
  methods: {
    ...
    confirmKeyFig(index) {
      ...
      this.clearEdit();
      this.$store.commit(UPDATE_KEY_FIGURES, {

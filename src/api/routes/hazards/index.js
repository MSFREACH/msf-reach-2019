...
export default ({ logger }) => {
  ...
  api.get('/pdc', ensureAuthenticated, (req, res, next) =>
    PDC()
      .then(events => {
        res.status(200).json({
          statusCode: 200,
  ...
  api.get('/usgs', ensureAuthenticated, (req, res, next) =>
    USGS()
      .then(events => {
        res.status(200).json({
          statusCode: 200,
  ...
  api.get('/tsr', ensureAuthenticated, (req, res, next) =>
    TSR()
      .then(events => {
        res.status(200).json({
          statusCode: 200,
  ...
  api.get('/gdacs', ensureAuthenticated, (req, res, next) =>
    GDACS()
      .then(events => {
        res.status(200).json({
          statusCode: 200,
  ...
  api.get('/ptwc', ensureAuthenticated, (req, res, next) =>
    PTWC()
      .then(events => {
        res.status(200).json({
          statusCode: 200,
  ...
  // Get a list of all reports
  api.get('/lra', ensureAuthenticated, (req, res, next) =>
    LRA()
      .then(events => {
        res.status(200).json({
          statusCode: 200,

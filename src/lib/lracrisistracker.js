...
const LRA = () =>
  new Promise((resolve, reject) => {
    var options = {
      uri:
        'https://www.lracrisistracker.com//map.json?&attack_type=all_attacks&duration=month&request_type=max_records&primary_actors=LRA&start_date=2018-01-01&verification_ratings=',
      json: true
    };
      ...
      .then(function(result) {
        ...
        for (let i = 0; i < result.points.length; i++) {
          ...
          feature.properties.link =
            'https://www.lracrisistracker.com/incidents/' + event.id;
          feature.properties.start_date = event.start_date;
          feature.properties.id = event.id;
          feature.properties.lra_verification_rating =
            event.lra_verification_rating;
